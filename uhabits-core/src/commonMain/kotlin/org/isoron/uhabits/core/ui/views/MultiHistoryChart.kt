...
class MultiHistoryChart(
    ...
    private fun drawSquare(
        ...
        val quadrantOffsets = arrayOf(
            doubleArrayOf(0.0, 0.0),
            doubleArrayOf(halfWidth, 0.0),
            doubleArrayOf(0.0, halfHeight),
            doubleArrayOf(halfWidth, halfHeight)
        )
